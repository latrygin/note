...
Task _taskDeserialize(
  ...
  final object = Task(
    ...
    importance:
        _TaskimportanceValueEnumMap[reader.readByteOrNull(offsets[6])] ??
            TaskImportant.basic,
...
const _TaskimportanceValueEnumMap = {
  0: TaskImportant.basic,
  1: TaskImportant.low,
  2: TaskImportant.important,
};
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> changedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> changedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'lastUpdatedBy',
      ));
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastUpdatedBy',
        value: '',
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> lastUpdatedByIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'lastUpdatedBy',
        value: '',
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> sortByLastUpdatedBy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdatedBy', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByLastUpdatedByDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> thenByLastUpdatedBy() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdatedBy', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByLastUpdatedByDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdatedBy', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  ...
  QueryBuilder<Task, Task, QDistinct> distinctByLastUpdatedBy(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, TaskImportant, QQueryOperations> importanceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'importance');
    });
  }

  QueryBuilder<Task, String?, QQueryOperations> lastUpdatedByProperty() {
    return QueryBuilder.apply(this, (query) {
