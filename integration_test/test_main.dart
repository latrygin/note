...
void main(){
  ...
  /// Инициализация DI
  /// Router delegate
  di..registerSingleton<TaskRouterDelegate>(TaskRouterDelegate())
  ..registerSingleton<RouteInformationParser<NavigationStateDTO>>(TaskRouteInformationParser())
  ..registerSingleton<PlatformRouteInformationProvider>(DebugRouteInformationProvider())
